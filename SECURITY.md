...
| --------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `allowAnonymous`            | off                                                           | With it off, a request whose `authenticate` hook returns nothing is refused with `401`. Turning it on serves those callers with `auth: undefined`, leaving `canAccess` as the only gate on every primitive.  |
